...
<div class="row">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" id="laravel-ajax-file-upload" data-url="{{ route('update-profile',['id' => $id]) }}"action="javascript:void(0)" >
                        <div class="d-grid mb-3">
                            <label for="name">Name</label>
                            <input type="text" name="name" id="name" class="mb-sm-3 form-control" value="{{$users->name}}" aria-describedby="basic-addon1">
                            <label for="email">Email</label>
                            <input type="text" name="email" id="email" class="mb-sm-3 form-control" value="{{$users->email}}" aria-describedby="basic-addon1">
